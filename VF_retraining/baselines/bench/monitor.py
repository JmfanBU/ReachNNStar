...
def get_monitor_files(dir):
    return glob(osp.join(dir, "*" + LogMonitor.EXT))
...
def load_results(dir):
    ...
    if not monitor_files:
        raise LoadLogMonitorResultsError("no monitor files of the form *%s found in %s" % (LogMonitor.EXT, dir))
    dfs = []
    headers = []
