...
int main()
{
	...
	char const *neural_network = "nn_1_tanh_retrained";
	...
	ofstream result_output("./outputs/nn_1_tanh_retrained.txt");
	...
	plot_setting.plot_2D_interval_GNUPLOT("nn_1_tanh_retrained", result);
