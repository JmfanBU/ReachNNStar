...
int main()
{
	...
	char const *neural_network = "nn_relu_tanh_mixed3_origin1";
	...
	ofstream result_output("./outputs/nn_dubins_car_relu_tanh_origin.txt");
	...
	plot_setting.plot_2D_interval_GNUPLOT("nn_dubins_car_relu_tanh_origin", result);
