...
int main()
{
	...
	char const *neural_network = "nn_tora_ARCH_retrained";
	double err_max = 0;
	...
	plot_setting.setOutputDims(x2_id, x1_id);
	...
	ofstream result_output("./outputs/nn_tora_ARCH.txt");
	...
	plot_setting.plot_2D_interval_GNUPLOT("nn_tora_ARCH", result);
