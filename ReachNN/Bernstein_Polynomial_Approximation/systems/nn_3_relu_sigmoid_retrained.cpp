...
int main()
{
	...
	char const *neural_network = "nn_3_relu_sigmoid_retrained";
	...
	ofstream result_output("./outputs/nn_3_relu_sigmoid_retrained.txt");
	...
	plot_setting.plot_2D_interval_GNUPLOT("nn_3_relu_sigmoid_retrained", result);
